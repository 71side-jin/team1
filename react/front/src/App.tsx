...
export default function App() {
  ...
  async function handleTextFile(selectedFile: File): Promise<void> {
    ...
    setUploadedTextFileName(selectedFile.name);
  ...
  async function handleTextDrop(e: React.DragEvent<HTMLDivElement>): Promise<void> {
    e.preventDefault();
    setDragging(false);
  ...
  function handleTextPaste(e: React.ClipboardEvent<HTMLDivElement>): void {
    e.preventDefault();
  ...
  async function handleAnalyze(): Promise<void> {
    ...
    try {
      const response = await fetch("/api/analyze-text", {
        ...
        body: JSON.stringify({
          text,
          fileName: uploadedTextFileName || "pasted-text.txt",
        }),
      });
